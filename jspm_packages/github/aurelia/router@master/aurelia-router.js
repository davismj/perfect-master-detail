define(['exports', 'aurelia-logging', 'aurelia-route-recognizer', 'aurelia-dependency-injection', 'aurelia-history', 'aurelia-event-aggregator'], function (exports, _aureliaLogging, _aureliaRouteRecognizer, _aureliaDependencyInjection, _aureliaHistory, _aureliaEventAggregator) {
  ...
  function _buildNavigationPlan(instruction, forceLifecycleMinimum) {
    ...
    if (prev) {
      ...
      for (var viewPortName in instruction.router.viewPorts) {
        var viewPortConfig = instruction.config.viewPorts[viewPortName] || { moduleId: null };
  ...
  var AppRouter = exports.AppRouter = function (_Router) {
    ...
    AppRouter.prototype.loadUrl = function loadUrl(url) {
      ...
      return this._createNavigationInstruction(url).then(function (instruction) {
        ...
        if (!_this11.ignoreUnknownRoutes) {
          logger.error(error);
  ...
  function resolveInstruction(instruction, result, isInnerInstruction, router) {
    ...
    if (!isInnerInstruction) {
      ...
      var _eventArgs = { instruction: instruction, result: result };
      ...
      router.events.publish('router:navigation:' + eventName, _eventArgs);
      router.events.publish('router:navigation:complete', _eventArgs);
    } else {
